-- MoCA Platform — consolidated PostgreSQL schema (V1 + V2)
-- Reference only. Flyway applies migrations in db/migration/ on boot.
-- Database: moca-test-db @ 192.168.22.111
...
-- ── users ────────────────────────────────────────────────────────────────────
-- PATIENT login: phone_number | DOCTOR/ADMIN: email or phone
CREATE TABLE users (
...
-- ── patient_assignments ──────────────────────────────────────────────────────
-- One current doctor per patient (partial unique index)
